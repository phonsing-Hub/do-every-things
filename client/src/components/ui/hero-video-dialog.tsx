        ...
        {isVideoOpen && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-7xl aspect-video mx-4 md:mx-0"
            >
              <motion.button
                onClick={() => setIsVideoOpen(false)}
              ...
              <div className="w-full h-full border-2 border-white rounded-xl overflow-hidden isolate z-[1] relative">
                <iframe
                  src={videoSrc}
